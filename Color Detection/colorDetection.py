...
#         red1_found = findBalls(red1_contours)
#         red2_found = findBalls(red2_contours)
...
#         if red1_found is not None:
#             red_moments = cv2.moments(red1_found)
#             red_cX = int(red_moments["m10"] / red_moments["m00"])
#             red_cY = int(red_moments["m01"] / red_moments["m00"])
#             red_x, red_y, red_w, red_h = cv2.boundingRect(red1_found)
#             cv2.rectangle(frame, (red_x, red_y), (red_x + red_w, red_y + red_h), (0, 0, 255), 2)
#             cv2.circle(frame, (red_cX, red_cY), 10, (0, 0, 255), -1)
#         elif red2_found is not None:
#             red_moments = cv2.moments(red2_found)
#             red_cX = int(red_moments["m10"] / red_moments["m00"])
#             red_cY = int(red_moments["m01"] / red_moments["m00"])
#             red_x, red_y, red_w, red_h = cv2.boundingRect(red2_found)
#             cv2.rectangle(frame, (red_x, red_y), (red_x + red_w, red_y + red_h), (0, 0, 255), 2)
#             cv2.circle(frame, (red_cX, red_cY), 10, (0, 0, 255), -1)

#         if blue_found is not None:
#             blue_moments = cv2.moments(blue_found)
#             blue_cX = int(blue_moments["m10"] / blue_moments["m00"])
#             blue_cY = int(blue_moments["m01"] / blue_moments["m00"])
#             blue_x, blue_y, blue_w, blue_h = cv2.boundingRect(blue_found)
#             cv2.rectangle(frame, (blue_x, blue_y), (blue_x + blue_w, blue_y + blue_h), (255, 0, 0), 2)
#             cv2.circle(frame, (blue_cX, blue_cY), 10, (255, 0, 0), -1)
...
class Detection:
    ...
    while True:
        ...
        for redBallOne in red1_found:
            ...
            cv2.rectangle(frame, (red_x, red_y), (red_x + red_w, red_y + red_h), (0, 0, 255), 2)
            cv2.circle(frame, (red_cX, red_cY), 10, (0, 0, 255), -1)
        for redBallTwo in red2_found:
            red_moments = cv2.moments(redBallTwo)
            red_cX = int(red_moments["m10"] / red_moments["m00"])
            red_cY = int(red_moments["m01"] / red_moments["m00"])
            red_x, red_y, red_w, red_h = cv2.boundingRect(redBallTwo)
            cv2.rectangle(frame, (red_x, red_y), (red_x + red_w, red_y + red_h), (0, 0, 255), 2)
            cv2.circle(frame, (red_cX, red_cY), 10, (0, 0, 255), -1)
